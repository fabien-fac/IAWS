...
public class VelibdispoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_velibdispo, container, false);
    ...
    private void init_composants() {
		...
		btnSearch = (ImageButton) rootView.findViewById(R.id.velibdispo_imgbutton_search);
    ...
    private void activate_btn_search(){
    	...
    	ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(),
				android.R.layout.simple_dropdown_item_1line, list_string_stations);
